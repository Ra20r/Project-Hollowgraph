...
The final format of the data from ard_code_1 is: each group of 180 rows correspond to each angle and total number of columns correspond to the number of observations for each angle.
